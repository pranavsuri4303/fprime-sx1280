// ======================================================================
// \title  LoraFprimeDemoDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef LORAFPRIMEDEMODEPLOYMENT_LORAFPRIMEDEMODEPLOYMENTTOPOLOGY_HPP
#define LORAFPRIMEDEMODEPLOYMENT_LORAFPRIMEDEMODEPLOYMENTTOPOLOGY_HPP
// Included for access to LoraFprimeDemoDeployment::TopologyState and LoraFprimeDemoDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <LoraFprimeDemoDeployment/Top/LoraFprimeDemoDeploymentTopologyDefs.hpp>
 ...
 * LoraFprimeDemoDeployment::TopologyState see: LoraFprimeDemoDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type LoraFprimeDemoDeployment::TopologyState see: LoraFprimeDemoDeploymentTopologyDefs.hpp.
 *
